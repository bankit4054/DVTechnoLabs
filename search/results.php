...
<head>
    ...
    <meta name="description" content="TechNest Labs - Startup Agency and SasS Business Template" />

    <!-- title  -->
    <title>TechNest Labs - Startup Agency and SasS Business Template</title>
